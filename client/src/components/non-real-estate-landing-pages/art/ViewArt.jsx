        ...
        <main className="ml-0 xl:ml-10 my-10 space-y-10">
          <section className="space-y-2.5">
            <div className="w-full h-[calc(50vh-64px)] bg-cyan-50 rounded-xl overflow-hidden border border-cyan-100">
              ...
              >
                {Array(3)
                  .fill(
                    "https://images.unsplash.com/photo-1577083862199-97d54558971f?auto=format&fit=crop&q=80&w=2009&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                  )
                  .map((i, j) => (
                    <SwiperSlide
                      key={j}
          ...
          <section className="space-y-2.5">
            ...
            <p className="relative text-sm">
              ...
              <span className="absolute left-32 capitalize">
                {property?.dimensions || "---"} cm<sup>2</sup>
              </span>
            </p>
            <p className="relative text-sm">
              <span>Year</span>
