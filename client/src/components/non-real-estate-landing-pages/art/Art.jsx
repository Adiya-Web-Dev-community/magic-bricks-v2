...
const Art = ({ category }) => {
  ...
  return (
    <main>
      <section className="bg-[url(https://images.unsplash.com/photo-1576769267415-9642010aa962?auto=format&fit=crop&q=80&w=1886&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D)] bg-center bg-cover h-[calc(100vh-64px)] w-full grid place-items-center">
        <h1 className="text-slate-300 text-4xl md:text-6xl font-extralight w-full mx-5 text-center flex flex-col items-center space-y-2.5">
          <span className="font-montserrat">Collect & co-own</span>
          <span className="font-montserrat">Masterpieces of art</span>
        </h1>
      </section>
              ...
              {properties.map((i, j) => (
                ...
                >
                  <div className="flex flex-col p-5 space-x-0 space-y-5">
                    ...
                    <div className="bg-slate-100 rounded-xl p-5 space-y-2.5 w-80 sm:w-96">
                      <p className="text-sm flex items-center justify-between text-slate-500">
                        <span className="">Artwork</span>
                        <span>{i.artworkTitle || "---"}</span>
                      </p>
                      <p className="text-sm flex items-center justify-between text-slate-500">
