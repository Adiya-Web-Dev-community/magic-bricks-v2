...
const Car = ({ category }) => {
  ...
  return (
    <main>
      <section className="bg-[url(https://images.unsplash.com/photo-1603584173870-7f23fdae1b7a?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2069&q=80)] bg-center bg-cover h-[calc(100vh-64px)] w-full grid place-items-center">
        <h1 className="text-slate-300 text-4xl md:text-6xl font-extralight w-full mx-5 text-center flex flex-col items-center space-y-2.5">
          ...
          <span className="font-montserrat">Buy your dream car now!</span>
        </h1>
      </section>
