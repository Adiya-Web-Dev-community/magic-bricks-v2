          ...
          <section className="space-y-2.5">
            <div className="w-full h-[calc(50vh-64px)] bg-cyan-50 rounded-xl overflow-hidden border border-cyan-100">
              ...
              >
                {Array(3)
                  .fill(
                    "https://images.unsplash.com/photo-1549317661-bd32c8ce0db2?auto=format&fit=crop&q=80&w=2070&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                  )
                  .map((i, j) => (
                    <SwiperSlide
                      key={j}
