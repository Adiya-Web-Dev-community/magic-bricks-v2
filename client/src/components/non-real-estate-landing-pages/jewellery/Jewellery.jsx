...
const Jewellery = ({ category }) => {
  ...
  return (
    <main>
      <section className="bg-[url(https://images.unsplash.com/photo-1586878340506-af074f2ee999?auto=format&fit=crop&q=80&w=2070&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D)] bg-center bg-cover h-[calc(100vh-64px)] w-full grid place-items-center">
        <h1 className="text-slate-100 text-4xl md:text-6xl font-extralight w-full mx-5 text-center flex flex-col items-center space-y-2.5">
          ...
          <span className="font-montserrat">Buy your jewellery now!</span>
        </h1>
      </section>
                    ...
                    <div className="flex flex-col p-5 space-x-0 space-y-5">
                      <div className="relative">
                        ...
                        <div className="block absolute bottom-2.5 right-2.5 z-10 space-x-2">
                          <button className="w-16 h-8 rounded-md bg-slate-300 animate-pulse cursor-default"></button>
                        </div>
                      </div>
              ...
              {properties.map((i, j) => (
                ...
                >
                  <div className="flex flex-col p-5 space-x-0 space-y-5">
                    ...
                    <div className="bg-slate-100 rounded-xl p-5 space-y-2.5 w-80 sm:w-96">
                      <p className="text-sm flex items-center justify-between text-slate-500">
                        <span className="">Jewellery type</span>
                        <span>{i.jewelryType || "---"}</span>
                      </p>
                      <p className="text-sm flex items-center justify-between text-slate-500">
