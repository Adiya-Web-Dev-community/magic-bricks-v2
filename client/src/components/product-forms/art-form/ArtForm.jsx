...
import AdditionalInfo from "./ArtFormSteps/AdditionalInfo";

const formList = ["art details", "art images", "additional information"];

const Form = ({ category }) => {
  const [activeForm, setActiveForm] = useState("art details");
