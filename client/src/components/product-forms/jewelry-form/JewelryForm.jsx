...
import AdditionalInfo from "./jewelryFormSteps/AdditionalInfo";
...
const Form = ({ category }) => {
  const [activeForm, setActiveForm] = useState("jewellery details");
